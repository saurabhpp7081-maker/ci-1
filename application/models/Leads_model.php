...
class Leads_model extends App_Model
{
    ...
    public function add($data)
    {
        ...
        $data = $this->filter_lead_table_data($data);
    ...
    public function update($data, $id)
    {
        ...
        $data['email'] = trim($data['email']);
        $data = hooks()->apply_filters('before_lead_updated', $data);
        $data = $this->filter_lead_table_data($data);
    ...
    private function filter_lead_table_data($data)
    {
        $leadFields = $this->db->list_fields(db_prefix() . 'leads');
        $filtered   = [];
        ...
        foreach ($data as $key => $value) {
            ...
            if (in_array($key, $leadFields, true)) {
                $filtered[$key] = $value;
            }
        }
